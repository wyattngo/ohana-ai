...
GD0-CHAT  ─┘     (TogetherClient tái dùng từ GD0-CHAT — cùng LLM client, khác đường ra)
      └─ mount api/webhook.py cần: GD0-DRAFTER (có impl) + GD0-ZALO (PRE-004, kẹt Tân)
         ⇒ GD0-HISTORY xong chỉ gỡ MỘT trong hai điều kiện

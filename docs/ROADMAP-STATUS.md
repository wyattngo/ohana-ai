...
> **AUTO-GENERATED bởi `.claude/tools/adp-roadmap.sh` @ 2026-07-20T23:23.**
...
**Internal: 10/28 work item hoàn tất (35%)** ← đây là mẫu số của "100% Roadmap"
External: 0/9 (0%) — chờ bên thứ ba, **không tính vào 100%**
Phase gate-passed: 30/42
...
_(không có — mọi phase đều có khoá nối hợp lệ)_

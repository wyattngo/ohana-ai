...
- **Gate hiện tại:** pytest xanh (`-m 'not live'`, **183 test**, 6 live deselected) · ruff sạch (`--no-cache`) · mypy 0 lỗi / **53 file** — scope = toàn bộ code sản phẩm, không loại thư mục nào (2026-07-21).

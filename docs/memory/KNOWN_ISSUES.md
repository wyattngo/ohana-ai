...
- `HISTORY_MAX_CHARS=4000` ⇒ **~1128 token thật**, KHÔNG phải "~1800" issue ghi. Con số 1800 tự
  mâu thuẫn với chính tỉ lệ 3.3 của nó (4000/3.3 = 1212) — sai nội tại, không chỉ chưa đo. Cap
  không làm vỡ ngân sách token; nếu lệch thì lệch phía bảo thủ.

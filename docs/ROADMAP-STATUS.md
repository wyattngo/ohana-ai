...
> **AUTO-GENERATED bởi `.claude/tools/adp-roadmap.sh` @ 2026-07-20T20:25.**
...
**Internal: 10/27 work item hoàn tất (37%)** ← đây là mẫu số của "100% Roadmap"
External: 0/9 (0%) — chờ bên thứ ba, **không tính vào 100%**
Phase gate-passed: 28/38

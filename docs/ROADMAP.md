...
| `GD0-INTENT` | `workflow#w-7.2-rules-intent` | |
| `GD0-DRAFTSCHEMA` | `workflow#w-7.3-draftschema` | |
| `GD0-SHOPS` | `workflow#w-7.4-shop-profile` | |
| `GD0-DRAFTER` | `workflow#w-7.5-draft-pipeline` | |
| `GD0-HISTORY` | `workflow#w-7.5-draft-pipeline` | |
| `GD0-POLICY` | `workflow#w-7.5-draft-pipeline` | |
| `GD0-PII` | `workflow#w-7.6-pii-dpia` | |
| `GD0-WIKI` | `workflow#w-7.7-corpus-luong-a` | |
| `GD0-EMBED` | `workflow#w-7.7-corpus-luong-a` | |
| `GD0-CHAT` | `workflow#w-7.7-corpus-luong-a` | |
| `GD0-METER` | `workflow#w-7.5-draft-pipeline` | `# weak-mapping` — metering xuyên suốt, không phải 1 step |
...
| `GD0-TOOLS` | `workflow#w-7.5-draft-pipeline` | `# weak-mapping` — WHY thật ở §3 tầng-1 |
...
| `GD0-EVAL` | — | ⏳ chờ `w-8-ai-eng` (Wyatt viết workflow §8 AI engineering) |
| `GD0-ROUTER` | — | ⏳ chờ `w-8-ai-eng` |
| `GD0-OBS` | — | ⏳ chờ `w-8-ai-eng` |
